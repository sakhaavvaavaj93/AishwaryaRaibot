...
import AishwaryaRaibot.modules.sql.notes_sql as sql
from AishwaryaRaibot import dispatcher, LOGGER, OWNER_ID, SUDO_USERS, MESSAGE_DUMP
from AishwaryaRaibot.__main__ import DATA_IMPORT
from AishwaryaRaibot.modules.helper_funcs.chat_status import user_admin
from AishwaryaRaibot.modules.helper_funcs.misc import build_keyboard, revert_buttons
from AishwaryaRaibot.modules.helper_funcs.msg_types import get_note_type
from AishwaryaRaibot.modules.rules import get_rules
import AishwaryaRaibot.modules.sql.rules_sql as rulessql
from AishwaryaRaibot.modules.sql import warns_sql as warnssql
import AishwaryaRaibot.modules.sql.blacklist_sql as blacklistsql
from AishwaryaRaibot.modules.sql import disable_sql as disabledsql
from AishwaryaRaibot.modules.sql import cust_filters_sql as filtersql
import AishwaryaRaibot.modules.sql.welcome_sql as welcsql
import AishwaryaRaibot.modules.sql.locks_sql as locksql
from AishwaryaRaibot.modules.connection import connected
...
def export_data(bot: Bot, update: Update, chat_data):
    ...
    f=open("AishwaryaRaibot{}.backup".format(chat_id), "w")
    ...
    try:
        ...
        pass
    bot.sendDocument(current_chat_id, document=open('AishwaryaRaibot{}.backup'.format(chat_id), 'rb'), caption="*Successfully imported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This  is specially made for notes.".format(chat.title, chat_id, tgl), timeout=360, reply_to_message_id=msg.message_id, parse_mode=ParseMode.MARKDOWN)
    os.remove("AishwaryaRaibot{}.backup".format(chat_id)) # Cleaning file
